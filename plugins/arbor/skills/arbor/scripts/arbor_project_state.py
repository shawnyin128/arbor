...
def hookless_runtime_contract() -> str:
    ...
    return "\n".join(
        [
            ...
            "Project Map drift context, including the Git commit convention reminder.",
            ...
            "Do not create native git hooks from Arbor unless the user explicitly asks for that separate integration.",
            "",
